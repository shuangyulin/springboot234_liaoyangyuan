    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(yonghu !=null){
            ...
            BeanUtils.copyProperties( yonghu , view );//把实体数据重构到view中
                ...
                //级联表
                YishengEntity yisheng = yishengService.selectById(yonghu.getYishengId());
                if(yisheng != null){
    ...
    */
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(false)
            ...
            yonghu.setYishengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
...
//                            yonghuEntity.setYonghuName(data.get(0));                    //患者姓名 要改的
...
//                            yonghuEntity.setYishengId(Integer.valueOf(data.get(0)));   //医生 要改的
...
//                            yonghuEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        // role_types.get(yisheng.getRoleTypes());
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "患者");
        R r = R.ok();
        r.put("token", token);
        r.put("role","患者");
