<template>
    <div style="backgroundImage: url('/liaoyangyuan/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">疗养院管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="手机号" class="input" v-if="tableName=='yisheng'">
                            <el-input v-model="ruleForm.yishengPhone" autocomplete="off" placeholder="手机号"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            //// 患者 的 医生
                            // if((!this.ruleForm.yishengId)&& 'yonghu'==this.tableName){
