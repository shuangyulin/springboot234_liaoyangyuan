    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="反馈标题" prop="liuyanName">
                       <el-input v-model="ruleForm.liuyanName"
                                 placeholder="反馈标题" clearable  :readonly="ro.liuyanName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="反馈标题" prop="liuyanName">
                           <el-input v-model="ruleForm.liuyanName"
                                     placeholder="反馈标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="反馈内容" prop="liuyanText">
                        <el-input type="textarea"  :readonly="ro.liuyanText" v-model="ruleForm.liuyanText" placeholder="反馈内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.liuyanText" label="反馈内容" prop="liuyanText">
                            <span v-html="ruleForm.liuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24" v-if="(type=='info' && role=='患者') || role!='患者'">
